...
static struct api_data *bitfury16_api_stats(struct cgpu_info *bitfury)
{
	...
	root = api_add_string(root, "hwv1", "1", true); // 1
	root = api_add_string(root, "hwv2", "3", true); // 2
	root = api_add_string(root, "hwv3", "0", true); // 11
	root = api_add_string(root, "hwv4", "1", true); // 0
 	root = api_add_string(root, "hwv5", "0", true); // 0
